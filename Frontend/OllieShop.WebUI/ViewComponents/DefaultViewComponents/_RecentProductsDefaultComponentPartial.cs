...
namespace OllieShop.WebUI.ViewComponents.DefaultViewComponents
{
    public class _RecentProductsDefaultComponentPartial:ViewComponent
    {
        ...
        public _RecentProductsDefaultComponentPartial(IApiService apiService)
        {
            _apiService = apiService;
        }
        public async Task<IViewComponentResult> InvokeAsync()
        {
            var products = await _apiService.GetAsync<List<ResultProductDto>>("https://localhost:7220/api/Products");
